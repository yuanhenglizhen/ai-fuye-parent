package com.hanzaitu.ai.draw.domain;
...
public class Message<T> {
	@ApiModelProperty("状态码: 200成功, 201提示, 其他错误")
	...
	public static final int WAITING_CODE = 201;
	public static final int NOT_FOUND_CODE = 400;
	public static final int VALIDATION_ERROR_CODE = 405;
