...
public class RedisCache
{
     ...
     * @return
     */
    public List<T> getAllCacheMapValue(final String key)
    {
        HashOperations<String, String, T> opsForHash = redisTemplate.opsForHash();
     ...
     * @return 是否成功
     */
    public void deleteCacheMapValueByList(final String key, final List<String> hKeyList)
    {
        for (String hk : hKeyList) {
     ...
     * @return
     */
    public Object bpush(String key, Object data) {
        try {
