package com.hanzaitu.common.interceptor.impl;
...
import com.hanzaitu.common.filter.RepeatedlyRequestWrapper;
import com.hanzaitu.common.interceptor.RepeatSubmitInterceptor;
import com.hanzaitu.common.utils.StringUtils;
import com.hanzaitu.common.utils.http.HttpHelper;
...
//    private String header;
    ...
    public boolean isRepeatSubmit(HttpServletRequest request, RepeatSubmit annotation)
    {
        ...
        // 唯一值（没有消息头则使用请求地址）
        String submitKey = StringUtils.trimToEmpty(request.getHeader(""));
