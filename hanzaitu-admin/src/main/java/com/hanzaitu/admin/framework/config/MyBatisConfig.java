...
import com.hanzaitu.common.core.mybatis.HztMetaObjectHandler;
...
//    }
    @Bean
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource, GlobalConfig globalConfig, MybatisPlusProperties mybatisPlusProperties) throws Exception {
    ...
    //        sqlSessionFactory.setTypeHandlersPackage("com.baomidou.mybatisplus.samples.mysql.type");
        ...
        //自动填充插件
        globalConfig.setMetaObjectHandler(new HztMetaObjectHandler());
    ...
    public GlobalConfig globalConfig() {
        ...
        DefaultSqlInjector logicSqlInjector = new DefaultSqlInjector() {
            ...
            public List<AbstractMethod> getMethodList(Class<?> mapperClass, TableInfo tableInfo) {
                ...
                methodList.add(new AlwaysUpdateSomeColumnById(t -> t.getFieldFill() != FieldFill.INSERT && !t.isLogicDelete()));
                return methodList;
            }
        };
