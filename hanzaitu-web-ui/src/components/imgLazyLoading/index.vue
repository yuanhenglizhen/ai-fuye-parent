        ...
        <div class="image-column" v-for="(column, index) in columns" :key="index">
            <div class="image-item" v-for="(image,i) in column" :key="image.id">
                ...
                <div class="image-icons">
                    ...
                    <span class="icon" :class="image.squareStatus?'icon-like':''" @click="handleLike(image.taskId,index,i)"></span>
                    <!--<span class="icon icon-favorite" @click="handleFavorite(image.id)"></span>-->
                </div>
                <!--<div class="marks"></div>-->
...
<script>
    export default {
        ...
        watch:{
            ...
            tagLable(val){
                this.paramsList.labelId = val;
                this.paramsList.pageNo = 1;
                this.images = [];
                this.loadImages();
            },
            sortType(val){
                this.paramsList.sortType = val;
                this.paramsList.pageNo = 1;
                this.images = [];
                this.loadImages();
            },
        ...
        mounted() {
            ...
            //this.$refs.scrollable.addEventListener('scroll', this.handleScroll); // 监听页面滚动事件
...
<style lang="scss" scoped>
    ...
    .scroll-to-top {
        ...
        height: 6.4rem;
        cursor: pointer;
        background: url("https://image.hanzaitu.com/static/other/ALL-icon.png") no-repeat;
