<template>
  <div>
      ...
      <div class="form-item">
        ...
        <div class="form-control">
          <input
            ...
            placeholder-class="form-input-placeholder"
            class="form-input"
            :class="inviteCodeErrorText ? 'error' : ''"
            placeholder="请输入好友邀请码,非必填"
          />
          <div class="error-text font-24">{{ inviteCodeErrorText }}</div>
        </div>
      </div>
      <div class="form-item">
        <div class="form-control">
    ...
    <div class="other">
      ...
      <div class="right" @click="redirect('login')">登录 </div>
    </div>
...
import { register, sendRegisterCode } from "@/api/h5";
...
export default {
  ...
  methods: {
    ...
    handleConfirm() {
      ...
      //   this.inviteCodeErrorText = "请输入邀请码";
      //   formError = true;
      // }
